...
function OpportunityCard({
  ...
  return (
    ...
    >
      ...
      {/* Tagline + problem */}
      <div>
        <p className="font-bold text-foreground text-[14px] leading-snug mb-1" style={{ letterSpacing: '-0.01em' }}>
      ...
      <div className="flex items-center justify-between gap-2">
        ...
        {opp.differentiation_angle && (
          <span className="text-[9px] font-medium px-2 py-0.5 rounded-full bg-secondary border border-border text-muted-foreground truncate">
            {opp.differentiation_angle.slice(0, 40)}
          </span>
        )}
      </div>
    </div>
